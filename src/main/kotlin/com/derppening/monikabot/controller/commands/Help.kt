...
object Help : IBase, ILogger {
    ...
    override fun delegateCommand(event: MessageReceivedEvent, args: List<String>): CommandInterpreter.HandleState {
    ...
    private fun listFunctions(embed: EmbedBuilder): EmbedBuilder {
        return embed.apply {
            ...
            appendField("`taf`", "Displays TAF information for an airfield.", false)
