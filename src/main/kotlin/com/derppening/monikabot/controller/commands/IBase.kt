...
interface IBase : ILogger {
     ...
     */
    fun delegateCommand(event: MessageReceivedEvent, args: List<String> = listOf()): CommandInterpreter.HandleState {
        ...
        if (event.isFromSuperuser()) {
            ...
            if (suHandleStatus != CommandInterpreter.HandleState.UNHANDLED) {
     ...
     * @return Whether the action is handled.
     */
    fun handler(event: MessageReceivedEvent): CommandInterpreter.HandleState {
     ...
     * @return Whether the action is handled.
     */
    fun handlerSu(event: MessageReceivedEvent): CommandInterpreter.HandleState {
